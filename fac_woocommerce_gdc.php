...
function custom_rewrite_rules() {
  ...
  add_rewrite_rule('^fac-confirm-transaction/?', 'index.php?fac_confirm_transaction=1', 'top');
  add_rewrite_rule('^fac-3ds-redirect/?', 'index.php?fac_3ds_redirect=1', 'top');
  add_rewrite_rule('^fac-card-confirmed-transaction/?', 'index.php?fac_card_confirmed_transaction=1', 'top');
...
function add_custom_query_var($query_vars) {
  $query_vars[] = 'fac_confirm_transaction';
  $query_vars[] = 'fac_3ds_redirect';
  $query_vars[] = 'fac_card_confirmed_transaction';
  return $query_vars;
}
