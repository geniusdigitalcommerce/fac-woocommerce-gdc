...
namespace FacPayments\Repositories\InMemory;

use FacPayments\Contracts\Repositories\ICurrencyRepository;
...
class InMemoryCurrencyRepository implements ICurrencyRepository{
     ...
     * @return int
     */
    public function getMinorUnit($currencyCode){
        return intval(
            $this->getCurrencyProperty($currencyCode,'minor_unit')
        );
    }
     ...
     * @return int
     */
    public function getNumericCode($currencyCode){
        return strval(
            $this->getCurrencyProperty($currencyCode,'numeric_code')
        );
    }
